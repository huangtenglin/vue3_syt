      ...
      <div class="left">
        <img
          :src="
            ...
            detailStore.hospitalInfo.hospital?.logoData
          "
          alt=""
        />
      </div>
...
const changeIndex = (index: number) => {
  ...
  // 实现一个滚动滚动效果
  let deparmentInfo = document.querySelector('.deparmentInfo') as HTMLElement;
  let showDeparment = document.querySelectorAll(
    '.showDeparment'
  ) as NodeListOf<Element>;
  deparmentInfo!.scrollTo({
    top:
      (showDeparment[currentIndex.value]! as HTMLElement).offsetTop -
      deparmentInfo!.offsetTop,
    behavior: 'smooth',
  });
};
